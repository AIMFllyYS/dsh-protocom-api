 ...
 */
export const RETRYABLE_FAILURE_CODES: readonly string[] = Object.freeze([
  'EMPTY_RESPONSE',
  'RATE_LIMIT',
  'SERVER',
  'TIMEOUT',
 ...
 */
export function retryPolicyFor(budget: RetryBudget): RouteRetryPolicy {
 ...
 */
export function retryBudgetSpanMs(budget: RetryBudget): number {
  let total = 0
