 ...
 */
export const COMMANDCODE_CONTEXT_LADDER: readonly number[] = [200_000, 256_000, 400_000, 1_000_000]
 ...
 */
export const COMMANDCODE_REFUSED_MODEL_IDS: readonly string[] = []
 ...
 * own order instead.
 */
export const COMMANDCODE_RECOMMENDED: readonly string[] = []
