window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const FUSION_SETTINGS_NS = "model-fusion";
		...
		*/
		function createFusionOperations(ctx) {
			...
			return {
				...
				applyLeader: async (seat) => {
					...
					if (current === void 0) return failures;
					...
					if (target === void 0) return failures;
...
`;
		...
		*/
		...
		function apply(ctx) {
			...
			const fusionAvailable = () => ctx.get("remote") !== void 0 && ctx.remote.session !== void 0 && ctx.get("settingsScope") !== void 0;
