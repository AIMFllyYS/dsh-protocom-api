window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const LENGTHS_256K = [131072, CONTEXT_256K];
		/**
		...
		*/
		...
		const STANDARD_VARIANT_CHOICES = [
			131072,
			262144,
			524288,
			1048576
		...
		*/
		...
		function toggleLength(lengths, length) {
			return (lengths.includes(length) ? lengths.filter((candidate) => candidate !== length) : [...lengths, length]).sort((a, b) => a - b);
		}
		//#endregion
				...
				children: [
					...
					probe.phase === "ready" && probe.models.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", { children: t("colVariants") })
						] }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: probe.models.map((model) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: entry.displayName }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "protocom-probe-id",
									children: model.id
								}) }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: variantChoicesFor(model.id).map((length) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
		...
		*/
		function ModelVisibilityCard({ hidden, writable, revision, operations, t, onChanged }) {
			...
			const write = (next) => {
				...
				setBusy(true);
				setError(void 0);
				operations.writeSettings(next.length === 0 ? [{
					op: "unset",
					path: ["hiddenModels"]
				}] : [{
					op: "set",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: identities.map(({ displayName, ids, entry }) => {
							...
							const meta = [
								...
								...entry.reasoning === void 0 ? [] : [t("tagReasoning")]
							].join(" · ");
		...
		*/
		...
		const en = {
			...
			modelsHint: "Every known model is offered by default. Clear the ones you do not want the model menu to list — hiding only affects the menu, never a session already using that model.",
			selectAll: "Show all",
			selectNone: "Hide all",
			tagVision: "vision",
		...
		const zh = {
			...
			colVariants: "上下文变体",
			models: "菜单中显示的模型",
			modelsHint: "默认展示全部已知模型。取消勾选即可从模型菜单中隐藏；隐藏只影响菜单，不影响已在使用该模型的会话。",
			selectAll: "全部显示",
			selectNone: "全部隐藏",
			tagVision: "视觉",
			tagReasoning: "思考",
...
.protocom-model-chip.is-on .protocom-model-dot { background: var(--dsh-accent, #3a7bfd); border-color: var(--dsh-accent, #3a7bfd); }
.protocom-model-chip.is-off { opacity: 0.45; }
.protocom-model-chip.is-off .protocom-model-name { text-decoration: line-through; }
.protocom-model-chip:disabled { cursor: default; }
.protocom-model-name { font-weight: 500; }
.protocom-model-meta { font-size: 10.5px; opacity: 0.65; letter-spacing: 0.02em; }
.protocom-model-tools { display: flex; gap: 6px; margin-left: auto; }
