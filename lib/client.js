	...
	factory: (require) => {
		...
		function GroupCard({ groupKey, group, credential, writable, revision, probe, hidden, recommended, contexts, vision, operations, t, onChanged, onProbe }) {
			...
			const loadBalance = async () => {
				...
				try {
					...
					if (data === void 0) throw new Error(t("balanceUnavailable"));
					setBalance({
						phase: "ready",
						data,
						error: void 0
			...
			const entryCount = visibleRows.reduce((total, row) => {
				const lengths = contexts[identityKey(row.upstreamId)] ?? variantLengths(row.contextOptions, group.contextLengths) ?? [row.contextWindow];
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", { children: t("probeDetails") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: probe.phase === "ready" && probe.models.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: matchRegistry(model.id)?.displayName ?? (model.name !== void 0 && model.name !== model.id ? model.name : model.id) }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: "protocom-probe-id",
											children: model.id
										}) }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: servesChat(model.id) ? t("servedYes") : t("servedNo") })
									] }, model.id)) })]
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: "protocom-notice",
		...
		*/
		...
		function Loaded({ operations, t }) {
			...
			const probeKey = GROUP_KEYS.filter((key) => groupValueOf(section, key).enabled && state.credentials[defaultKeyRef(key)]?.configured === true && probes[key] === void 0).join(",");
			(0, react.useEffect)(() => {
			...
			const applyBaseURL = () => {
				...
				const needsCustom = origin !== void 0 && origin !== DEFAULT_BASE_URL_ORIGIN;
