...
export function serializeChatRequest(options, model, images, replayReasoning = false, assistantTextReplay = 'keep') {
    const messages = [];
...
export async function* streamChatCompletions(connection, options, model, images, replayReasoning = false, assistantTextReplay = 'keep') {
    const response = await postSse(connection, 'chat/completions', serializeChatRequest(options, model, images, replayReasoning, assistantTextReplay), options.signal);
