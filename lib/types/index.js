...
export { catalogEntry, contextLabel, displayNameWithContext, FALLBACK_CONTEXT_WINDOW, matchRegistry, REGISTRY, } from "./model-registry.js";
    ...
    ctx.effect(() => {
        ...
        const discovery = ctx.llm.registerModelDiscovery(NS, (request, signal) => discoverModels(request, signal, {
            ...
            resolveApiKey: async (provider) => {
                ...
                if (group === undefined || !group.enabled || group.apiKeyRef === undefined)
                    return undefined;
                try {
