 ...
 */
export declare function subagentFacts(session: {
    readonly header?: {
        readonly origin?: 'subagent';
        readonly isSeeded?: boolean;
    };
} | undefined): SubagentSessionFacts;
/**
 ...
 */
export declare function fuseCallConfig(resolved: LlmCallConfig, fusion: ResolvedFusion, facts: SubagentSessionFacts): LlmCallConfig;
